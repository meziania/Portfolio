  ...
  return (
    <div className="page-wrap">
      <Reveal className="hero">
        <div className="eyebrow mono">DÉVELOPPEUR LOGICIEL — FULL-STACK · SYSTÈMES SÉCURISÉS · DATA & IA</div>
        <h1>
          I build full-stack software,<br />secure it by <span>design</span>,<br />and back it with data.
        </h1>
        <p className="lead">
          Développeur full-stack spécialisé dans la conception d&apos;applications web sécurisées de bout en
          bout — de la base de données à l&apos;interface en production — avec une expertise complémentaire en
          ingénierie des données, IA et gestion de projet structurée (Scrum).
        </p>
