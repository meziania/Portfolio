...
export const fr: Content = {
  ...
  projects: [
    ...
    },
    {
      ...
      mockup: "gpsi",
      status: { label: "PROJET ACADÉMIQUE · STAGE", kind: "neutral" },
      ptag: "FULL-STACK · ITSM · PARC INFORMATIQUE",
      title: "GPSI — Gestion de parc et support informatique",
      description: "Application interne réalisée en stage PFA chez Food Group Trading : inventaire du parc, tickets avec SLA, trois rôles (admin, technicien, utilisateur) et copilote IA (Ollama) avec repli heuristique. MVP local, pas un produit déjà en production.",
      tags: ["Laravel", "Inertia", "React", "TypeScript", "PostgreSQL", "Ollama"],
      note: "MVP de stage — code disponible sur demande",
    },
    {
      id: "optigest",
      ...
      mockup: "optigest",
      status: { label: "LIVRÉ", kind: "live" },
      ptag: "DESKTOP · MAGASIN D'OPTIQUE",
      title: "Opti Gest",
      description: "Application desktop Windows et Mac pour magasin d'optique : fiches clients, ordonnances, devis et factures PDF, suivi mutuelles (CNOPS / CNSS), catalogue articles et rappels WhatsApp / SMS. Données en local (SQLite), installateur unique.",
      tags: ["Electron", "React", "Express", "Prisma", "SQLite", "TypeScript"],
      links: [
        { label: "GitHub →", href: "https://github.com/meziania/OptiGest" },
        { label: "Installateur →", href: "https://github.com/meziania/OptiGest/releases/latest" },
      ],
    },
    {
      id: "2r",
